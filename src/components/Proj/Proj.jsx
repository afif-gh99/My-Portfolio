    ...
    <div className=" overflow-hidden">
      <div className="relative overflow-hidden rounded-xl shadow-2xl group">
        ...
        <Link
          onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
          to={more}
          className="absolute top-3 left-3 text-white  rounded-xl px-2.5 py-1 bg-[#0c97e27e] block lg:hidden"
        >
          More Details
        </Link>
      </div>
      <div className="mt-8  text-main-black dark:text-white duration-300">
        <h1 className="font-semibold text-[22px] mb-[11px] text-shadow-md/30 dark:text-shadow-white">
          {title}
        </h1>
        <div className="flex justify-between items-center">
          ...
          >
            ...
            <span
              className="absolute bottom-full mb-2 px-3 py-1
                        text-xs text-main-black dark:text-white bg-gray-100 dark:bg-gray-800 rounded opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 duration-200 whitespace-nowrap"
            >
              Project Demo
            </span>
          </a>

...
const Hero = ({ title, subTilte, URLcv, profileImg, socialLinks }) => {
  return (
    <div
      name="home"
      className="lg:h-[calc(100vh-80px)] h-[calc(100vh)] flex lg:flex-row flex-col justify-center items-center lg:gap-10 gap-7 pt-20 "
    >
      <div className="text-main-black dark:text-white duration-300 relative order-3 lg:order-1">
        ...
        >
          ...
          <h1 className="font-bold text-shadow-lg/30 dark:text-shadow-white lg:text-[55px] text-3xl  lg:w-[560px] leading-[110%] lg:mb-10 mb-5">
        ...
        >
          ...
          <a
            className="block w-fit mt-[30px] px-[34px] py-3.5 bg-priamry text-white rounded-lg font-medium text-sm hover:bg-hover  duration-300 shadow-xl dark:shadow-gray-700"
            href={URLcv}
            download
          >
            Download CV
        ...
        <img
          className="absolute top-0 -left-[70px] pointer-events-none"
      ...
      <div className="relative order-1 lg:order-2">
        ...
        >
          <div className="bg-[#cae0eb] lg:w-[500px] w-[300px] h-[150px] lg:h-[300px] flex justify-center rounded-4xl shadow-2xl dark:shadow-gray-700">
            <img
              className="absolute lg:w-[380px] w-[200px] bottom-0 "
              src={profileImg}
              alt="profile"
            />
          </div>
          ...
          <img
            className="absolute -bottom-5 w-12"
            src="/assets/images/shining.webp"
            alt=""
          />
          <img
            className="absolute -bottom-1.5 right-1  w-12"
            src="/assets/images/shining.webp"
            alt=""
          />
          <img
            className="absolute -top-12 left-10 w-12"
            src="/assets/images/shining.webp"
            alt=""
          />
        </motion.section>
      ...
      <div className="order-2 lg:order-3 flex flex-row lg:flex-col justify-center items-center lg:gap-8 gap-12 text-main-black ">
        <motion.section
          ...
          viewport={{ once: true, amount: 0.2 }}
        >
          <p className="lg:[writing-mode:vertical-rl] dark:text-white duration-300 lg:text-base text-sm">
            Follow me on:
          </p>
        </motion.section>
        <motion.section
          ...
          <div className="flex flex-row lg:flex-col  justify-center items-center lg:gap-9 gap-6">
            ...
            {socialLinks.map((link, index) => {
              return (
                ...
                >
                  <a
                    className="lg:text-2xl text-xl text-priamry hover:text-hover duration-200 hover:scale-150"
                    href={link?.url}
                    target="_blank"
